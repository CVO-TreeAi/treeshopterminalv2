...
export const treeShopConfig = {
  ...
  // Standard Service Packages - Updated pricing from internal XML
  packages: {
    forestryMulching: [
      {
        id: "fm-4dbh",
        name: "Small Package (4\" DBH)",
        description: "Grind vegetation up to 4\" diameter at breast height",
        basePrice: 2125,
        pricePerAcre: 2125,
        minAcres: 0.5,
        maxDBH: 4,
      ...
      {
        id: "fm-10dbh",
        name: "X-Large Package (10\" DBH)",
        description: "Grind vegetation up to 10\" diameter at breast height",
        basePrice: 4250,
        pricePerAcre: 4250,
        minAcres: 0.5,
        maxDBH: 10,
