...
export default function Home() {
    ...
    return (
      <div className="min-h-screen bg-gray-900 text-white flex items-center justify-center">
        <div className="text-center bg-gray-800 p-8 rounded-lg shadow-xl max-w-md w-full">
          <h1 className="text-3xl font-bold mb-6">TreeShop Terminal</h1>
          <p className="text-gray-400 mb-8">Sign in to access the lead management dashboard</p>
          <button
          ...
          <p className="text-xs text-gray-500 mt-6">
            Access restricted to office@fltreeshop.com
          </p>
        </div>
      </div>
    );
  ...
  if (session.user?.email !== "office@fltreeshop.com") {
    return (
      <div className="min-h-screen bg-gray-900 text-white flex items-center justify-center">
        <div className="text-center bg-gray-800 p-8 rounded-lg shadow-xl max-w-md w-full">
          ...
          <p className="text-gray-400 mb-8">
            Only office@fltreeshop.com is authorized to access this dashboard.
          </p>
          <button
            onClick={() => signOut()}
